		...
		return {
			...
			link: function (scope, elem, attrs, controller) {
				...
				var itemTemplate = elem.html().trim() || '{{' + (match[2] || match[1]) + '}}',
					...
					dropdownTemplate =
					'<a class="form-control outerSearchIcon" type="search" data-toggle="dropdown" href ng-class="{ disabled: disabled }">' +
						'<img src="img/search.png" alt="search">' +
						'<b></b>' +
					'</a>' +
					'<div class="dropdown-menu">' +
						'<div stop-propagation="click" class="custom-select-search">' +
							'<input class="common-control ' + attrs.selectClass + '" type="text" placeholder="Search" autocomplete="off" ng-model="searchTerm" /> <span class="dropsearch-icon"><img src="img/search.png" alt="search" /></span>' +
						'</div>' +
						'<ul role="menu">' +
